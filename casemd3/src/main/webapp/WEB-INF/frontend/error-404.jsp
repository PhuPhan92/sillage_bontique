        ...
        <div class="row">
          <div class="col-12">
            <div class="error_form">
              <h1>404</h1>
              <h2>Opps! ĐÃ CÓ LỔI XẢY RA</h2>

              <p>Có thể bạn đã nhập sai môt số lổi như bên dưới<br> Vui lòng thử lại </p>
              <ol>
                <li>Giá tiền để trống hoặc sai định dạng, không phải là một số</li>
                <li>Số lượng để trống hoặc sai định dạng, không phải là một số</li>
                <li>Ngày để trống</li>
              </ol>
